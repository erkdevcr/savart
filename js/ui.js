...
const UI = (() => {
  ...
  const STRINGS = {
    es: {
      ...
      yt_linked_elsewhere:    'Tu app Savart está vinculada a la cuenta de YouTube de %s en otro dispositivo.',
    ...
    en: {
      ...
      yt_linked_elsewhere:    'Your Savart app is linked to YouTube account %s on another device.',
