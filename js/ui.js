...
const UI = (() => {
  ...
  const STRINGS = {
    es: {
      ...
      ds_send_scan_running:  'en curso',
      ds_send_scan_paused:   'pausado',
      ds_send_scan_desc:          'El escaneo está {state}. ¿Deseas detenerlo y enviar "{name}" al escáner?',
      ds_send_scan_pending_title: 'Datos incompletos',
      ds_send_scan_pending_desc:  'Hay {count} carpeta(s) con datos incompletos. Resuélvelas primero o descártalas para cargar "{name}".',
      ds_send_scan_discard_send:  'Descartar y enviar',
      ...
      settings_clear_home:      'Limpiar home',
      settings_clear_home_desc: 'Borra datos de uso del home. No afecta tus archivos en Drive.',
      settings_clear_selected:  'Limpiar seleccionados',
      settings_clearing:        'Limpiando…',
      settings_clear_hint:      'Esto puede tomar unos cuantos segundos',
      settings_normalizer_desc: 'Borra los gains guardados de todas las canciones. Cada canción será re-analizada la próxima vez que se reproduzca.',
      settings_reset_norm_btn:  'Resetear gains del normalizer',
      settings_resetting_norm:  'Reseteando…',
      settings_reset_norm_ok:   (n) => `Gains reseteados (${n} canciones). Se re-analizarán al reproducirse.`,
      settings_reset_norm_err:  'Error al resetear gains',
      settings_db_status:      'Estado de la DB',
      ...
      yt_linked_here:         'Tu app Savart está vinculada a la cuenta de YouTube de %s',
      yt_linked_elsewhere:    'Tu app Savart está vinculada a la cuenta de YouTube de %s en otro dispositivo. Para mantener la sincronización de tus playlists de YouTube, debes loguearte aquí también con la misma cuenta.',
      yt_change_account:      'Conectar otra cuenta',
      yt_change_title:        'Cambiar cuenta de YouTube',
      yt_change_msg:          'Tus playlists de YouTube desaparecerán. Los archivos descargados se conservarán.\n¿Continuar?',
      yt_change_confirm:      'Cambiar cuenta',
      yt_forced_logout_toast: 'La cuenta de YouTube fue desconectada desde otro dispositivo.',
      settings_appearance:    'Apariencia',
      settings_language:      'Idioma',
      settings_theme:       'Tema de la aplicación',
      theme_blue:           'Azul Savart',
      theme_purple:         'Púrpura Nébula',
      theme_green:          'Esmeralda',
      theme_amber:          'Ámbar Dorado',
      ...
      eq_group_bars:      'Agrupar barras',
      eq_custom_presets:  'Ajustes personalizados',
      speed_pin_label:    'Guardar para esta canción',
      sort_album:         'Álbum',
      sort_artist:        'Artista',
      eq_preset_flat:  'Plano',
      eq_preset_classical: 'Clásica',
      normalizer:      'Normalizador',
      live_gain:       'Ganancia dinámica',
      // ── Player badges ─────────────────────────────────────
      badge_speed:     'vel.',
      badge_norm:      'gan.',
      // ── Misc buttons ──────────────────────────────────────
      ...
      toast_offline_on:         'Modo offline activado',
      toast_offline_off:        'Modo offline desactivado',
      toast_folder_offline:     'Carpeta no disponible sin conexión',
      offline_stale_cache:      'Contenido en caché — puede estar desactualizado',
      ...
      scan_btn_stop:        'Detener',
      scan_btn_stopping:    'Deteniendo…',
      ds_reset_btn:              'Restablecer',
      ds_reset_confirm_title:    'Restablecer originales',
      ds_reset_confirm_body:     '¿Restablecer todos los metadatos de las carpetas escaneadas? Se eliminarán portadas, ediciones manuales y cualquier dato guardado. Esta acción no se puede deshacer.',
      ds_reset_confirm_ok:       'Restablecer',
      ds_resetting:              'Restableciendo…',
      ...
      ctx_ds_reset_row:        'Restablecer originales',
      ...
      nav_scan:             'Escanear y editar',
      ds_open_folder_btn:   'Abrir carpeta',
      ds_change_folder_btn: 'Cambiar carpeta',
      ds_no_songs:          'No se encontraron canciones para este álbum',
      lbl_col_name:         'Nombre',
      lbl_tipo:             'Tipo',
      ...
      toast_audio_error:    'Error de reproducción',
      toast_download_error: 'Error al descargar la canción',
      toast_sd_saved:       '✓ Guardado en Drive · Soundrop',
      toast_sd_save_error:  'Error al guardar en Drive',
      toast_clear_error:    'Error al limpiar',
      toast_lib_error:      'Error al actualizar la biblioteca',
      toast_type_error:     'Error al cambiar tipo',
      ...
      ds_rescan_folder_prompt: 'La carpeta "{name}" fue escaneada anteriormente. ¿Qué deseas hacer?',
      ds_err_scan_folder:      'Error al escanear la carpeta',
      ...
      ds_convert_to_col:       'Convertir a Colección',
      ds_convert_to_album:     'Convertir a Álbum',
      lbl_name:                'Nombre',
      lbl_title:               'Título',
      lbl_artist:              'Artista',
      lbl_album:               'Álbum',
    ...
    en: {
      ...
      ds_send_scan_running:  'in progress',
      ds_send_scan_paused:   'paused',
      ds_send_scan_desc:          'The scan is {state}. Do you want to stop it and send "{name}" to the scanner?',
      ds_send_scan_pending_title: 'Incomplete data',
      ds_send_scan_pending_desc:  'There are {count} folder(s) with incomplete data. Resolve them first or discard them to load "{name}".',
      ds_send_scan_discard_send:  'Discard and send',
      ...
      settings_clear_home:      'Clear home',
      settings_clear_home_desc: 'Clears home usage data. Does not affect your Drive files.',
      settings_clear_selected:  'Clear selected',
      settings_clearing:        'Clearing…',
      settings_clear_hint:      'This may take a few seconds',
      settings_normalizer_desc: 'Clears saved gains for all songs. Each song will be re-analyzed next time it plays.',
      settings_reset_norm_btn:  'Reset normalizer gains',
      settings_resetting_norm:  'Resetting…',
      settings_reset_norm_ok:   (n) => `Gains reset (${n} songs). They will be re-analyzed on next play.`,
      settings_reset_norm_err:  'Error resetting gains',
      settings_db_status:      'DB status',
      ...
      yt_linked_here:         'Your Savart app is linked to the YouTube account %s',
      yt_linked_elsewhere:    'Your Savart app is linked to YouTube account %s on another device. To keep your YouTube playlists in sync, log in here with the same account.',
      yt_change_account:      'Connect another account',
      yt_change_title:        'Change YouTube account',
      yt_change_msg:          'Your YouTube playlists will be removed. Downloaded files will be kept.\nContinue?',
      yt_change_confirm:      'Change account',
      yt_forced_logout_toast: 'YouTube account was disconnected from another device.',
      ...
      eq_group_bars:      'Group bars',
      eq_custom_presets:  'Custom presets',
      speed_pin_label:    'Save for this song',
      sort_album:         'Album',
      sort_artist:        'Artist',
      eq_preset_flat:  'Flat',
      ...
      toast_offline_on:         'Offline mode enabled',
      toast_offline_off:        'Offline mode disabled',
      toast_folder_offline:     'Folder unavailable offline',
      offline_stale_cache:      'Cached content — may be outdated',
      ...
      scan_btn_stop:        'Stop',
      scan_btn_stopping:    'Stopping…',
      ds_reset_btn:              'Reset',
      ds_reset_confirm_title:    'Reset to originals',
      ds_reset_confirm_body:     'Reset all metadata for the scanned folders? Cover art, manual edits, and all saved data will be erased. This cannot be undone.',
      ds_reset_confirm_ok:       'Reset',
      ds_resetting:              'Resetting…',
      ...
      ctx_ds_reset_row:        'Reset to originals',
      ...
      nav_scan:             'Scan & edit',
      ds_open_folder_btn:   'Open folder',
      ds_change_folder_btn: 'Change folder',
      ds_no_songs:          'No songs found for this album',
      lbl_col_name:         'Name',
      lbl_tipo:             'Type',
      ...
      toast_audio_error:    'Playback error',
      toast_download_error: 'Error downloading track',
      toast_sd_saved:       '✓ Saved to Drive · Soundrop',
      toast_sd_save_error:  'Error saving to Drive',
      toast_clear_error:    'Error clearing',
      toast_lib_error:      'Error updating library',
      toast_type_error:     'Error changing type',
      ...
      ds_rescan_folder_prompt: 'The folder "{name}" was previously scanned. What do you want to do?',
      ds_err_scan_folder:      'Error scanning folder',
      rescan_btn:           'Rescan',
      ...
      ds_convert_to_col:       'Convert to Collection',
      ds_convert_to_album:     'Convert to Album',
      lbl_name:                'Name',
      lbl_title:               'Title',
      lbl_artist:              'Artist',
      lbl_album:               'Album',
  ...
  function _buildFolderRow(folder, idx) {
    ...
    row.innerHTML = `
      ...
      <div class="folder-icon">
        ...
        <span class="folder-manual-dot" style="display:none"></span>
      </div>
  ...
  function showContextMenu(e, type, item, options = {}) {
    ...
    if (type === 'ds_folder') {
      ...
      _addCtxItem(menu, _iconFolder, t('ctx_go_to_folder'), () => { App.onGoToFolder?.(item); hideContextMenu(); });
      _addCtxDivider(menu);
      const _iconReset  = `<svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M12 5V1L7 6l5 5V7c3.31 0 6 2.69 6 6s-2.69 6-6 6-6-2.69-6-6H4c0 4.42 3.58 8 8 8s8-3.58 8-8-3.58-8-8-8z"/></svg>`;
      ...
      _addCtxItem(menu, _iconReset,  t('ctx_ds_reset_row'),        () => { App.onDsResetRow?.(item);        hideContextMenu(); });
  ...
  function renderPlaylistDetail(songs, name, pl = null) {
    ...
    // Mobile slide: save list pane scroll, then trigger CSS transition
    const listPane         = document.getElementById('lib-pl-list-pane');
    const _savedListScroll = listPane ? listPane.scrollTop : 0;
    if (twoCol)     twoCol.classList.add('detail-open');
    if (detailPane) detailPane.classList.add('open');
    // Scroll detail pane to top when opening
    if (detailPane) requestAnimationFrame(() => { detailPane.scrollTop = 0; });
    ...
    backRow.querySelector('.lib-back-btn').addEventListener('click', () => {
      if (twoCol) {
        ...
        // Restore list pane scroll position after slide-back
        if (listPane) requestAnimationFrame(() => { listPane.scrollTop = _savedListScroll; });
  ...
  function renderCollections(collections) {
    ...
    if (collections.length === 0) {
      container.innerHTML = `
        <div class="empty-state">
          <svg width="46" height="40" viewBox="0 0 361.54 315.2" fill="currentColor"><path d="M136.81,41.58C61.25,41.58,0,102.83,0,178.39s61.25,136.81,136.81,136.81,136.81-61.25,136.81-136.81S212.37,41.58,136.81,41.58ZM136.81,239.6c-33.8,0-61.21-27.4-61.21-61.21s27.4-61.21,61.21-61.21,61.21,27.4,61.21,61.21-27.4,61.21-61.21,61.21ZM136.81,191.78c-7.39,0-13.39-5.99-13.39-13.39s5.99-13.39,13.39-13.39,13.39,5.99,13.39,13.39-5.99,13.39-13.39,13.39ZM361.54,126.94c0,54.17-33.93,100.4-81.69,118.63,9.59-20.39,14.96-43.16,14.96-67.18,0-78.52-57.28-143.65-132.33-155.91C182.95,8.31,207.8,0,234.6,0c70.11,0,126.94,56.83,126.94,126.94Z"/></svg>
  ...
  function renderLibraryCollectionDetail(collection, songs) {
    ...
    // Build mosaic from enriched songs — include blob: URLs since they're valid this session.
    // Up to 4 distinct covers, deduped by URL.
    const _localMosaicUrls = [];
    { const seen = new Set();
      for (const s of songs) {
        if (_localMosaicUrls.length >= 4) break;
        if (s.thumbnailUrl && !seen.has(s.thumbnailUrl)) {
          seen.add(s.thumbnailUrl);
          _localMosaicUrls.push(s.thumbnailUrl);
        }
      }
    }
    ...
    // Never fall back to a song's individual URL — that belongs to the song, not the collection.
