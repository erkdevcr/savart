...
const APP_VERSION  = '3.5.582';
const CACHE_NAME   = `savart-shell-v${APP_VERSION}`; // 3.5.582 — playlist desde home: scroll a ítem activo en col izq; recordar scroll al cambiar tab
