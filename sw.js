...
const APP_VERSION  = '3.5.580';
const CACHE_NAME   = `savart-shell-v${APP_VERSION}`; // 3.5.580 — fix chip SD-lock: border-radius directo en segmentos para evitar rect blanco
