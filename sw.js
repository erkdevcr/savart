...
const CACHE_NAME   = `savart-shell-v${APP_VERSION}`; // 1.9.9 — scroll restore on Back in Collections; 1.9.5 — soft scan head increased 256KB→1MB so ID3 artist/album/title survive large embedded covers
