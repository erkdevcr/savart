...
const APP_VERSION  = '3.5.601';
const CACHE_NAME   = `savart-shell-v${APP_VERSION}`; // 3.5.601 — EQ: btn-eq-group alineado a la derecha (margin-left:auto) — EQ: botón "Agrupar barras" (Group bars) — toggle welded-drag: todas las bandas se mueven con el mismo delta; azul activo / gris inactivo; misma estética que Save Current
