...
const APP_VERSION  = '3.5.400';
const CACHE_NAME   = `savart-shell-v${APP_VERSION}`; // 3.5.400 — normalizer: target -14→-16 dBFS, boost máx +12→+6 dB (más conservador, cap también en apply para valores cacheados)
