...
const APP_VERSION  = '3.5.232';
const CACHE_NAME   = `savart-shell-v${APP_VERSION}`; // 3.5.232 — dot grid SPEED 0.333 (3s cycle); per-blob speed multiplier + dual-frequency drift for organic randomness
