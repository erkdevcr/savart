...
const APP_VERSION  = '3.5.257';
const CACHE_NAME   = `savart-shell-v${APP_VERSION}`; // 3.5.257 — EQ curve peak margin 6→14px; preamp/balance on mobile; center tick on sliders
